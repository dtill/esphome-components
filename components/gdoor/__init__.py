...
def validate_rx_sens_and_pin(cfg):
    ...
    """
    # Assume rx_pin is explicitly provided in cfg.
    rx_pin = cfg[CONF_RX_PIN]
    # Check if the provided rx_pin is not 22.
    if rx_pin != 22:
        # If rx_sens is provided and is not "high", that's an error.
